...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="title">Settings Language Documentation</xsl:param>
    ...
    <html>
      ...
      <body>
        ...
        <table width="100%" cellspacing="0" border="0">
          <tr class="address">
            <td width="30%" align="left">Copyright <xsl:text disable-output-escaping="yes">&amp;copy;</xsl:text> 2010 Nokia Corporation</td>
  ...
  <xsl:template match="rng:element">
    ...
    <div class="settingsLanguageElement">
      ...
      <xsl:if test="starts-with($hasatts, 'true')">
        <h3>Attributes</h3>
        <table class="settingsLanguageAttributes">
          <tr>
            <th>Attribute</th>
            <th>Type</th>
            <th>Use</th>
