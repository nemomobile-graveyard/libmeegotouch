...
#ifndef TEXTPROCESSORIF_H
#define TEXTPROCESSORIF_H
...
class TextProcessorIf : public DuiServiceFwBaseIf
{
    Q_OBJECT
...
public:
    ...
    TextProcessorIf(const QString &preferredService = "", QObject *parent = 0);
