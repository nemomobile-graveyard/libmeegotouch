...
// this is a second test case taken from duihome
// it doesn't have the DUI_EXPORT in the class line

class StatusIndicatorMenuModel : public DuiWidgetModel
{
    Q_OBJECT
    DUI_MODEL(StatusIndicatorMenuModel)
    ...
    DUI_MODEL_PROPERTY(QList<SettingsItem *>, settingsItems, SettingsItems, true, QList<SettingsItem *>())
};
