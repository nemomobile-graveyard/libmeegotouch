...
#include "duigen_processor.h"

int main(int argc, const char *argv[])
{
    if (argc != 4 && argc != 3) {
        qWarning() << "usage: duigen option header [outdir]";
        qWarning() << " option:";
        qWarning() << "   --model";
        qWarning() << "   --style";
        qWarning() << "Examples:";
        qWarning() << "duigen --model duibuttonmodel.h ";
        qWarning() << "duigen --model duibuttonmodel.h gen_models/";
        return 1;
    }
