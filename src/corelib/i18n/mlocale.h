 ...
 * variables of POSIX. MLocale is created with one main
 * language/country information for it, but can be overridden with
 * category specific settings. E.g.  having messages in
 * english/u.s. but using finnish collation (MLcCollation category)
 * and number formatting (MLcNumeric).
 *
 ...
 * systems. The actual collation is done with the MCollator class.
 *
 ...
 *
 * If MLocale is instantiated without any parameters, it will create
 ...
 * MLocale defaultLocale; // English settings are copied
 * \endverbatim
 */
