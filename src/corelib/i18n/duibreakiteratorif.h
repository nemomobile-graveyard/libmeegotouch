...
#ifndef DUIBREAKITERATORIF_H
#define DUIBREAKITERATORIF_H
...
/*! \internal
 * This class describes the interface that both DuiIcuIterator
 * and DuiNullIterator implement. It is used to have the possibility
