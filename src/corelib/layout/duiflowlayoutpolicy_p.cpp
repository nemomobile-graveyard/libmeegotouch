...
DuiFlowLayoutPolicyPrivate::DuiFlowLayoutPolicyPrivate(DuiLayout *l) :
...
DuiFlowLayoutPolicyPrivate::~DuiFlowLayoutPolicyPrivate()
{ }

bool DuiFlowLayoutPolicyPrivate::roomForItemOnCurrentRow(const QSizeF &item_size, const qreal &constraint_width, QPointF *position, qreal *row_height) const
{
    Q_ASSERT(position);
