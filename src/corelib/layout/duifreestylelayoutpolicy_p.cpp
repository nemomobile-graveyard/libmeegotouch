...
DuiFreestyleLayoutPolicyPrivate::DuiFreestyleLayoutPolicyPrivate(DuiLayout *l) :
    DuiAbstractLayoutPolicyPrivate(l)
{ }

DuiFreestyleLayoutPolicyPrivate::~DuiFreestyleLayoutPolicyPrivate()
{ }

QRectF DuiFreestyleLayoutPolicyPrivate::moveAway(const QRectF &to_move,
...
bool DuiFreestyleLayoutPolicyPrivate::placeItem(int indexToPlace,
