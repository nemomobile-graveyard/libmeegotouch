...
#ifndef DUIDATAACCESS_H
#define DUIDATAACCESS_H
 ...
 */
class DUI_EXPORT DuiDataAccess : public QObject
{
    Q_OBJECT

public:
    /*!
     * Destroys the DuiDataAccess.
     */
    virtual ~DuiDataAccess() {}
