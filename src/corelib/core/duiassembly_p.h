...
#ifndef DUIASSEMBLY_P_H
#define DUIASSEMBLY_P_H
...
public:
    ...
    void loadStylesheet(const QString &stylesheet, const DuiLogicalValues &logicalValues);
    void loadStylesheets(const QStringList &themeInheritance, const DuiLogicalValues &logicalValues);
};
