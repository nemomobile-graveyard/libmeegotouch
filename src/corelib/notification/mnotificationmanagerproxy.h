...
#ifndef MNOTIFICATIONMANAGERPROXY_H_1350988927
#define MNOTIFICATIONMANAGERPROXY_H_1350988927
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QList < MNotification > > GetNotifications(const QString &app_name)
    {
        QList<QVariant> argumentList;
...
namespace org {
  namespace freedesktop {
    typedef ::MNotificationManagerProxy Notifications;
  }
}
#endif
