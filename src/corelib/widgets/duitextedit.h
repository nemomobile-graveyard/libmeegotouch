...
#ifndef DUITEXTEDIT_H
#define DUITEXTEDIT_H
...
/*!
 * \class DuiTextEdit
 * \brief DuiTextEdit is used to edit and display both plain and rich text.
 *
 ...
 *
 * DuiTextEdit can operate in single or multiline mode.
 ...
 *
 */
class DUI_EXPORT DuiTextEdit : public DuiWidgetController
{
    Q_OBJECT
    DUI_CONTROLLER(DuiTextEdit)

    Q_PROPERTY(QString text READ text WRITE setText NOTIFY textChanged USER true)
    // TODO: following type should be Dui::TextContentType, unfortunately due to a moc bug,
    ...
    Q_PROPERTY(QString selectedText READ selectedText) //TODO: not usable from outside at the moment, DUI_MODEL_PROPERTY always need set and get function.
    ...
    Q_PROPERTY(DuiTextEditModel::EchoMode echoMode READ echoMode WRITE setEchoMode)

public:
    typedef Dui::TextContentType TextContentType; // workaround for moc bug
     ...
     */
    explicit DuiTextEdit(DuiTextEditModel::LineMode type = DuiTextEditModel::SingleLine,
     ...
     */
    void setContentType(Dui::TextContentType type);
     ...
     */
    DuiTextEditModel::EchoMode echoMode() const;

    /*!
     * \brief Sets the echo mode which determines how input is made visible.
     */
    void setEchoMode(DuiTextEditModel::EchoMode echoMode);
    ...
    */
    ...
    /*!
     * \brief sets the DuiTextEdit only to accept input that the validator accepts.
     ...
     */
    void setCompleter(DuiCompleter *completer);
