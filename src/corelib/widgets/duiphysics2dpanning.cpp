...
DuiPhysics2DPanningPrivate::DuiPhysics2DPanningPrivate(DuiPhysics2DPanning *publicObject) :
...
DuiPhysics2DPanning::DuiPhysics2DPanning(QObject *parent)
    : QObject(parent),
      d_ptr(new DuiPhysics2DPanningPrivate(this))
{
...
void DuiPhysics2DPanning::integrateAxis(Qt::Orientation orientation,
                                        qreal &position,
                                        qreal &velocity,
                                        qreal &acceleration,
...
#include "moc_duiphysics2dpanning.cpp"
