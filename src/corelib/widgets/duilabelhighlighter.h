...
#ifndef DUILABELHIGHLIGHTER_H
#define DUILABELHIGHLIGHTER_H
...
/*!
    ...
    Class is used to highlight text fragments from DuiLabel. Class will also
    receive user interaction events when clicking and long pressing a highlighted
    piece of text.

    \ingroup widgets
*/
class DUI_EXPORT DuiLabelHighlighter
{
public:

    /*!
        \brief Destructs DuiLabelHighlighter.
    */
    virtual ~DuiLabelHighlighter();
...
/*!
    \class DuiCommonLabelHighlighter
    \brief Common highlighter class for easily highlighting items from DuiLabel without inheriting own classes.

    Inherits DuiLabelHighlighter and emits signals for the click and longPress interactions.

    \ingroup widgets
*/
class DuiCommonLabelHighlighterPrivate;
class DUI_EXPORT DuiCommonLabelHighlighter : public QObject, public DuiLabelHighlighter
{
    Q_OBJECT
...
public:
    ...
    */
    DuiCommonLabelHighlighter(const QRegExp &regExp);

    /*!
        \brief Destructs DuiCommonLabelHighlighter.
    */
    virtual ~DuiCommonLabelHighlighter();
...
private:
    DuiCommonLabelHighlighterPrivate *const d_ptr;
    Q_DECLARE_PRIVATE(DuiCommonLabelHighlighter)
};
