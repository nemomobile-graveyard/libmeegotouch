...
#ifndef DUINOTIFICATIONANIMATION_H
#define DUINOTIFICATIONANIMATION_H
#include <QtGlobal>
...
class DuiNotificationAnimationPrivate;

/*!
  \class DuiNavigationbarAnimation
  \brief
 */
class DuiNotificationAnimation : public DuiSceneWindowAnimation
{
    Q_OBJECT
    Q_DECLARE_PRIVATE(DuiNotificationAnimation)
...
protected:
     ...
     */
    DuiNotificationAnimation(DuiNotificationAnimationPrivate *dd, DuiSceneWindow *window, QObject *parent = NULL);
...
public:
     ...
     */
    DuiNotificationAnimation(DuiSceneWindow *window, QObject *parent = NULL);
