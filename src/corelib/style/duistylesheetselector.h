...
#ifndef DUISTYLESHEETSELECTOR_H
#define DUISTYLESHEETSELECTOR_H
 ...
 */
class DUI_EXPORT DuiStyleSheetSelector
{
    //friend class DuiStyleSheetParser;
...
public:
    ...
    /*!
     * DuiStyleSheetSelector constructor
    ...
    explicit DuiStyleSheetSelector(const QString &objectName = "",
     ...
     */
    DuiStyleSheetSelector(const DuiStyleSheetSelector &selector);

    //! Destructor for DuiStyleSheetSelector class
    virtual ~DuiStyleSheetSelector();

    /*!
     * \brief Provides access for the attributes of this selector.
     */
    DuiAttributeList *attributes();
...
private:
    Q_DECLARE_PRIVATE(DuiStyleSheetSelector)
    DuiStyleSheetSelectorPrivate *const d_ptr;
};
