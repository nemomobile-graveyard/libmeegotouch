...
#ifndef DUIBUTTONSWITCHVIEW_H
#define DUIBUTTONSWITCHVIEW_H

#include <duibuttonview.h>
#include <duibuttonmodel.h>
#include <duibuttonswitchstyle.h>

class DuiButtonSwitchViewPrivate;
class DuiButton;

/*!
    \class DuiButtonSwitchView
    \brief View class for switch button.

    \ingroup views

    \section DuiButtonSwitchViewOverview Overview
    ...
    \section DuiButtonSwitchViewInteractions Interactions
    ...
    \section DuiButtonSwitchViewOpenIssues Open issues

    \sa DuiButton DuiButtonView DuiButtonSwitchStyle
*/
class DUI_EXPORT DuiButtonSwitchView : public DuiButtonView
{
    Q_OBJECT
    DUI_VIEW(DuiButtonModel, DuiButtonSwitchStyle)
...
public:
     ...
     */
    DuiButtonSwitchView(DuiButton *controller);

    /*!
        \brief Destructs the view.
     */
    virtual ~DuiButtonSwitchView();
