...
#ifndef DUICOMBOBOX_H
#define DUICOMBOBOX_H
...
/**
    \class DuiComboBox
    \brief DuiComboBox implementation of a comboBox widget.

    \ingroup widgets

    \section DuiComboBox Overview
        ...
        DuiComboBox uses the Qt's model/view framework for its popup list and to store its items.
        By default a QStandardItemModel stores the items and a DuiPopupList displays the popuplist.
        You can access the model by model(), but DuiComboBox also provides functions
...
class DUI_EXPORT DuiComboBox : public DuiWidgetController
{

    Q_OBJECT
    DUI_CONTROLLER(DuiComboBox)

    /**
        \property DuiComboBox::iconID
        \brief See DuiComboBoxModel::iconID
    */
    Q_PROPERTY(QString iconID READ iconID WRITE setIconID)

    /**
        \property DuiComboBox::iconVisible
        \brief See DuiComboBoxModel::iconVisible
    */
    Q_PROPERTY(bool iconVisible READ isIconVisible WRITE setIconVisible)

    /**
        \property DuiComboBox::title
        \brief See DuiComboBoxModel::title
    */
    ...
    */
    ...
    /*!
        \property DuiComboBox::selectionModel  keeps track of itemModel selected items.
    */
...
public:
     ...
     */
    DuiComboBox(QGraphicsItem *parent = 0);
    ...
    */
    ...
    /**
       ...
       DuiComboBox does not take ownership of the model.
...
protected:
    ...
    //! \internal
    DuiComboBox(DuiComboBoxPrivate *dd, DuiComboBoxModel *model, QGraphicsItem *parent);
    //! \internal_end
