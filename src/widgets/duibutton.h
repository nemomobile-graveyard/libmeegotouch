...
class DuiButtonPrivate;
class DuiButtonGroup;
class DuiWidget;

/*!
    \class DuiButton
    \brief DuiButton implementation of a common button widget.

    \ingroup widgets

    \section DuiButtonOverview Overview
        DuiButton provides functionality of check, toggle and push button types.
        A button can display a label containing text and an icon. setText() sets
        the text. setIconID() sets the logical icon identifier.

        DuiButton provides the following states for buttons:
        ...
        DuiButton provides the following signals:
    ...
    \section DuiButtonUseGuidelines Usage guidelines
        ...
        - Additionally, buttons can be presented by themselves, or linked together
          as a button group. See ::DuiButtonGroup for details.
        - Buttons do not support launching the object menu by long press.

    \section DuiButtonVariants Variants
        \li \link DuiButtonView Default button view. \endlink View is used
            to visualize standard push buttons and checkboxes.
        \li \link DuiButtonIconView Icon view. \endlink View is used to
            visualize icon buttons.

    \section DuiButtonOpenIssues Open issues
    ...
    \section DuiButtonExamples Examples
        ...
        \code
            ...
            //toggle button
            DuiButton* toggleButton = new DuiButton("Toggle Button");
            toggleButton->setViewType(DuiButton::toggleType);
            toggleButton->setCheckable(true);

            //switch
            DuiButton* switch = new DuiButton();
            switch->setViewType(DuiButton::switchType);
            switch->setCheckable(true);

            //icon button
            DuiButton* iconButton = new DuiButton();
            iconButton->setViewType(DuiButton::iconType);
        \endcode
        ...
        \code
            ...
            DuiButton* checkable = new DuiButton();
            checkable->setViewType(DuiButton::checkboxType);
    ...
    \sa DuiButtonModel DuiButtonStyle DuiButtonGroup
*/
class DUI_EXPORT DuiButton : public DuiWidgetController
{
    Q_OBJECT
    DUI_CONTROLLER(DuiButton)

    /*!
        \property DuiButton::text
        \brief See DuiButtonModel::text
    */
    Q_PROPERTY(QString text READ text WRITE setText)

    /*!
        \property DuiButton::iconID
        \brief See DuiButtonModel::iconID
    */
    Q_PROPERTY(QString iconID READ iconID WRITE setIconID)

    /*!
        \property DuiButton::toggledIconID
        \brief See DuiButtonModel::toggledIconID
    */
    Q_PROPERTY(QString toggledIconID READ toggledIconID WRITE setToggledIconID)

    /*!
        \property DuiButton::textVisible
        \brief See DuiButtonModel::textVisible
    */
    Q_PROPERTY(bool textVisible READ isTextVisible WRITE setTextVisible)

    /*!
        \property DuiButton::iconVisible
        \brief See DuiButtonModel::iconVisible
    */
    Q_PROPERTY(bool iconVisible READ isIconVisible WRITE setIconVisible)

    /*!
        \property DuiButton::checkable
        \brief See DuiButtonModel::checkable
    */
    Q_PROPERTY(bool checkable READ isCheckable WRITE setCheckable)

    /*!
        \property DuiButton::checked
        \brief See DuiButtonModel::checked
    */
    Q_PROPERTY(bool checked READ isChecked WRITE setChecked DESIGNABLE isCheckable NOTIFY toggled USER true)

    /*!
        \property DuiButton::down
        \brief See DuiButtonModel::down
    */
...
public:
    ...
    */
    static const DuiTheme::ViewType toggleType;

    /*!
        \brief Variable that defines id for checkbox button variant.
    */
    static const DuiTheme::ViewType checkboxType;

    /*!
        \brief Variable that defines id for icon button variant.
    */
    static const DuiTheme::ViewType iconType;

    /*!
        \brief Variable that defines id for switch button variant.
    */
    static const DuiTheme::ViewType switchType;

    /*!
      \brief Constructs a button without text.
     */
    explicit DuiButton(QGraphicsItem *parent = 0, DuiButtonModel *model = 0);

    /*!
      \overload
      \brief Constructs a button with text.
     */
    explicit DuiButton(const QString &text, QGraphicsItem *parent = 0, DuiButtonModel *model = 0);

    /*!
      \overload
      \brief Constructs a button with icon and text.
     */
    DuiButton(const QString &iconID, const QString &text, QGraphicsItem *parent = 0, DuiButtonModel *model = 0);
    ...
    */
    ...
    /*!
      ...
      If the button is not a member of any DuiButtonGroup, this function returns 0.

      \see DuiButtonGroup.
     */
    DuiButtonGroup *group() const;
...
private:
    Q_DECLARE_PRIVATE(DuiButton)
    Q_DISABLE_COPY(DuiButton)

    friend class DuiButtonGroup;
};
