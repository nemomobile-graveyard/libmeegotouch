...
#ifndef DUICOMPLETER_P_H
#define DUICOMPLETER_P_H
...
class DuiCompletionModel;
class QTimer;

class DuiCompleterPrivate : public DuiSceneWindowPrivate
{
    Q_DECLARE_PUBLIC(DuiCompleter)

public:

    DuiCompleterPrivate();

    virtual ~DuiCompleterPrivate();
...
private:
    ...
    DuiCompletionModel *matchedModel;
...
class DuiCompletionModel : public QAbstractProxyModel
{
    Q_OBJECT

public:
    DuiCompletionModel(QObject *parent = 0);
...
private:
    ...
    friend class DuiCompleterPrivate;
};
