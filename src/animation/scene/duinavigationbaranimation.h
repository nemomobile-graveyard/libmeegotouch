...
#ifndef DUINAVIGATIONBARANIMATION_H
#define DUINAVIGATIONBARANIMATION_H
...
class DuiNavigationbarAnimationPrivate;

/*!
  \class DuiNavigationbarAnimation
  \brief
 */
class DuiNavigationbarAnimation : public DuiSceneWindowAnimation
{
    Q_OBJECT
    Q_DECLARE_PRIVATE(DuiNavigationbarAnimation)
...
protected:
     ...
     */
    DuiNavigationbarAnimation(DuiNavigationbarAnimationPrivate *dd, DuiSceneWindow *window, QObject *parent = NULL);
...
public:
     ...
     */
    DuiNavigationbarAnimation(DuiSceneWindow *window, QObject *parent = NULL);
