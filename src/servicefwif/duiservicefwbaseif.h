 ...
 *
 * DuiServiceFwBaseIf hides the servicefw machanisms from the derived class,
 * including service discovery and underlying IPC methods.
 */

class DUI_EXPORT DuiServiceFwBaseIf : public QObject
{
    Q_OBJECT
public:
    /*!
     ...
     */
    explicit DuiServiceFwBaseIf(const QString &iface, QObject *parent = 0);

    /*!
     * \brief Destructor
     */
    virtual ~DuiServiceFwBaseIf();
