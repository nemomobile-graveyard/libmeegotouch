...
#include "duiflowlayoutpolicy_p.h"
#include "duilayout.h"

#include <QtGui/QWidget>
DuiFlowLayoutPolicy::DuiFlowLayoutPolicy(DuiLayout *layout) :
    DuiAbstractLayoutPolicy(*(new DuiFlowLayoutPolicyPrivate(layout)))
{ }

DuiFlowLayoutPolicy::~DuiFlowLayoutPolicy()
{ }
...
int DuiFlowLayoutPolicy::rowCount()
{
...
void DuiFlowLayoutPolicy::invalidate()
{
    Q_D(DuiFlowLayoutPolicy);
    d->numberOfRows = -1;
}

void DuiFlowLayoutPolicy::relayout()
{
    Q_D(DuiFlowLayoutPolicy);
...
void DuiFlowLayoutPolicy::setRowLimit(int rowLimit)
{
    Q_D(DuiFlowLayoutPolicy);
    d->rowLimit = rowLimit;
    invalidatePolicyAndLayout();
}
int DuiFlowLayoutPolicy::rowLimit() const
{
    Q_D(const DuiFlowLayoutPolicy);
    return d->rowLimit;
}
