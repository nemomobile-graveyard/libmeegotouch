...
#ifndef DUILINEARLAYOUTPOLICY_H
#define DUILINEARLAYOUTPOLICY_H

#include "duiabstractlayoutpolicy.h"

class DuiLinearLayoutPolicyPrivate;
 ...
 *
 * \dontinclude duilinearlayoutpolicy/duilinearlayoutpolicy.cpp
 ...
 *
 * \sa \ref layout-duilinearlayoutpolicy
 *
 ...
 */
class DUI_EXPORT DuiLinearLayoutPolicy : public DuiAbstractLayoutPolicy
{
public:
    /*!
     ...
     */
    explicit DuiLinearLayoutPolicy(DuiLayout *layout, Qt::Orientation orientation);

    /*!
     * \brief Destroys the linear layout policy.
     */
    virtual ~DuiLinearLayoutPolicy();
...
private:
    Q_DISABLE_COPY(DuiLinearLayoutPolicy)
    Q_DECLARE_PRIVATE(DuiLinearLayoutPolicy)
};
