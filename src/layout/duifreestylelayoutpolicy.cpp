...
#include "duifreestylelayoutpolicy_p.h"
#include <QtGui/QWidget>
DuiFreestyleLayoutPolicy::DuiFreestyleLayoutPolicy(DuiLayout *layout) :
    DuiAbstractLayoutPolicy(*(new DuiFreestyleLayoutPolicyPrivate(layout)))
{ }

DuiFreestyleLayoutPolicy::~DuiFreestyleLayoutPolicy()
{ }

void DuiFreestyleLayoutPolicy::addItem(QGraphicsLayoutItem *item)
{
    addItemAtGeometry(item, QRectF(contentsArea().topLeft(), item->effectiveSizeHint(Qt::PreferredSize)));
}

void DuiFreestyleLayoutPolicy::addItemAtGeometry(QGraphicsLayoutItem *item, const QRectF &geom)
{
    Q_D(DuiFreestyleLayoutPolicy);
...
void DuiFreestyleLayoutPolicy::moveItemTo(QGraphicsLayoutItem *item, const QRectF &geom)
{
    Q_D(DuiFreestyleLayoutPolicy);
...
void DuiFreestyleLayoutPolicy::relayout()
{
    Q_D(DuiFreestyleLayoutPolicy);
...
void DuiFreestyleLayoutPolicy::removeAt(int index)
{
...
QSizeF DuiFreestyleLayoutPolicy::sizeHint(Qt::SizeHint which, const QSizeF &constraint) const
{
    Q_D(const DuiFreestyleLayoutPolicy);
