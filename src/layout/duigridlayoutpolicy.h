...
#ifndef DUIGRIDLAYOUTPOLICY_H
#define DUIGRIDLAYOUTPOLICY_H
 ...
 *
 * \dontinclude duigridlayoutpolicy/duigridlayoutpolicy.cpp
 ...
 *
 * \sa \ref layout-duigridlayoutpolicy
 *
 ...
 * DuiGridLayoutPolicy and QGraphicsGridLayout.  The current workaround is to
 ...
 * \skip Create a DuiLayout that we set the policy for
 ...
 */
class DUI_EXPORT DuiGridLayoutPolicy : public DuiAbstractLayoutPolicy
{
public:
    /*!
     ...
     */
    explicit DuiGridLayoutPolicy(DuiLayout *layout);

    /*!
     * \brief Destructor to clean up engine.
     */
    virtual ~DuiGridLayoutPolicy();
...
private:
    Q_DISABLE_COPY(DuiGridLayoutPolicy)
    Q_DECLARE_PRIVATE(DuiGridLayoutPolicy)
};
