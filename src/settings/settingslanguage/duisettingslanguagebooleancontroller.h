...
#ifndef DUISETTINGSLANGUAGEBOOLEANCONTROLLER_H
#define DUISETTINGSLANGUAGEBOOLEANCONTROLLER_H
 ...
 */
class DuiSettingsLanguageBooleanController : public QObject
{
    Q_OBJECT
...
public:
     ...
     */
    DuiSettingsLanguageBooleanController(QObject *parent = NULL);

    /*!
     * Destructor.
     */
    virtual ~DuiSettingsLanguageBooleanController();
