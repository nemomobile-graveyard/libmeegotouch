...
#ifndef DUIDBUSSERVICEWAITER_P_H
#define DUIDBUSSERVICEWAITER_P_H
 ...
 * appropriate signals.
 */
class DuiDBusServiceWaiter : public QObject
{
    Q_OBJECT
...
public:
     ...
     */
    DuiDBusServiceWaiter(const QString &name, QObject *parent = 0);
