...
#ifndef DUIDESKTOPENTRY_P_H
#define DUIDESKTOPENTRY_P_H

class DuiDesktopEntry;

/*!
 * DuiDesktopEntryPrivate is the private class for DuiDesktopEntry.
 */
class DuiDesktopEntryPrivate
{
    Q_DECLARE_PUBLIC(DuiDesktopEntry)

public:
    /*!
     * Constructs a new DuiDesktopEntryPrivate class.
     *
     * \param fileName the name of the file to read the desktop entry from
     */
    DuiDesktopEntryPrivate(const QString &fileName);

    /*!
     * Destroys the DuiDesktopEntryPrivate.
     */
    virtual ~DuiDesktopEntryPrivate();
