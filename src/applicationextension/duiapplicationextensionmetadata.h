...
#ifndef DUIAPPLICATIONEXTENSIONMETADATA_H_
#define DUIAPPLICATIONEXTENSIONMETADATA_H_

#include <duidesktopentry.h>

/*!
 * This class provides DUI application extension metadata such as extension
 ...
 * DuiApplicationExtensionMetaData data("filename.desktop");
 *
 ...
 * \endcode
 */
class DUI_EXPORT DuiApplicationExtensionMetaData : public DuiDesktopEntry
{
public:
    /*!
     * Constructs a new instance of DuiApplicationExtensionMetaData by reading the .desktop
     * file in that is given as a construction parameter.
     * \param filename Location of .desktop file to be read by constructed DuiApplicationExtensionMetaData instance.
     */
    DuiApplicationExtensionMetaData(const QString &filename);

    /*!
     * Destructor
     */
    virtual ~DuiApplicationExtensionMetaData();
...
private:
    ...
    Q_DISABLE_COPY(DuiApplicationExtensionMetaData)
};

#endif /* DUIAPPLICATIONEXTENSIONMETADATA_H_ */
