...
#ifndef DUIEXTENSIONHANDLE_P_H
#define DUIEXTENSIONHANDLE_P_H
...
/*!
 * A private data class for DuiExtensionHandle.
 */
class DuiExtensionHandlePrivate : public virtual QObject, public DuiWidgetControllerPrivate
{
    Q_DECLARE_PUBLIC(DuiExtensionHandle)
    Q_OBJECT
...
public:
     ...
     * Constructor.
     */
    DuiExtensionHandlePrivate();

    /*!
     * Destructor.
     */
    virtual ~DuiExtensionHandlePrivate();
