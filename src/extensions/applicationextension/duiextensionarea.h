...
#ifndef DUIEXTENSIONAREA_H
#define DUIEXTENSIONAREA_H
...
/*!
 * DuiExtensionArea is a baseclass for widgets that can load application extensions
 */
class DUI_EXPORT DuiExtensionArea : public DuiWidgetController
{
    Q_OBJECT
    DUI_CONTROLLER(DuiExtensionArea)
...
public:
     ...
     */
    explicit DuiExtensionArea(QGraphicsItem *parent = NULL);

    /*!
     * Default destructor
     */
    virtual ~DuiExtensionArea();
...
protected:
     ...
     * hierarchy.
     */
    DuiExtensionArea(DuiExtensionAreaPrivate *dd, DuiWidgetModel *model, QGraphicsItem *parent);
    DuiExtensionAreaPrivate *const d_ptr;
...
private:
    Q_DECLARE_PRIVATE(DuiExtensionArea)
    Q_DISABLE_COPY(DuiExtensionArea)
};

#endif // DUIEXTENSIONAREA_H
