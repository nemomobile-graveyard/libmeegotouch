...
#ifndef DUIAPPLETSHAREDMUTEXPRIVATE_H_
#define DUIAPPLETSHAREDMUTEXPRIVATE_H_
...
{
    Q_DECLARE_PUBLIC(DuiAppletSharedMutex)

public:
    DuiAppletSharedMutexPrivate();
    virtual ~DuiAppletSharedMutexPrivate();

    //! Public class
    DuiAppletSharedMutex *q_ptr;
...
#endif /* DUIAPPLETSHAREDMUTEXPRIVATE_H_ */
