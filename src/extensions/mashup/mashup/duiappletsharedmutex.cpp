...
#include "duiappletsharedmutex_p.h"
...
QString DuiAppletSharedMutexPrivate::createSharedMemoryKeyFileName(const QString &keyString)
{
    return QDir::tempPath() + "/dui_sharedmemory_" + keyString;
}

key_t DuiAppletSharedMutexPrivate::createSharedMemoryKey(const QString &fileName)
{
...
bool DuiAppletSharedMutexPrivate::initSharedMemory(const QString &keyString)
{
...
void DuiAppletSharedMutexPrivate::destroySharedMemory(const QString &keyString)
{
...
bool DuiAppletSharedMutexPrivate::initMutex(pthread_mutex_t *mutex)
{
    if (mutex != NULL) {
...
void DuiAppletSharedMutexPrivate::destroyMutex(pthread_mutex_t *mutex)
{
    if (mutex != NULL) {
...
DuiAppletSharedMutex::DuiAppletSharedMutex() : d_ptr(new DuiAppletSharedMutexPrivate)
{
}
...
bool DuiAppletSharedMutex::init(const QString &key)
{
...
bool DuiAppletSharedMutex::lock()
{
    Q_D(DuiAppletSharedMutex);
...
bool DuiAppletSharedMutex::unlock()
{
    Q_D(DuiAppletSharedMutex);
...
bool DuiAppletSharedMutex::tryLock()
{
    Q_D(DuiAppletSharedMutex);
