...
#ifndef DUIAPPLETMETADATA_H
#define DUIAPPLETMETADATA_H

#include <duidesktopentry.h>

/*!
 * This class provides dui applet metadata such as applet binary, appletrunner binary,
 ...
 * DuiAppletMetaData data("filename.desktop");
 *
 ...
 */
class DUI_EXPORT DuiAppletMetaData : public DuiDesktopEntry
{
public:
    /*!
     * Constructs a new instance of DuiAppletMetaData by reading the .desktop
     * file in that is given as a construction parameter.
     * \param filename Location of .desktop file to be read by constructed DuiAppletMetaData instance.
     */
    DuiAppletMetaData(const QString &filename);

    /*!
     * Destructor
     */
    virtual ~DuiAppletMetaData();
...
private:
    ...
    Q_DISABLE_COPY(DuiAppletMetaData)
};

#endif // DUIAPPLETMETADATA_H
