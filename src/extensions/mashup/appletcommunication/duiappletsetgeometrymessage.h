...
#ifndef DUIAPPLETSETGEOMETRYMESSAGE_H
#define DUIAPPLETSETGEOMETRYMESSAGE_H
 ...
 */
class DUI_EXPORT DuiAppletSetGeometryMessage : public DuiAppletMessage
{
private:
...
public:
     ...
     */
    explicit DuiAppletSetGeometryMessage(const QRectF &geometry = QRectF(), Qt::HANDLE handle = 0);

    /*!
     * Destructor.
     */
    virtual ~DuiAppletSetGeometryMessage();
...
#endif // DUIAPPLETSETGEOMETRYMESSAGE_H
