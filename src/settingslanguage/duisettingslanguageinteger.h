...
#ifndef DUISETTINGSLANGUAGEINTEGER_H
#define DUISETTINGSLANGUAGEINTEGER_H
 ...
 */
class DuiSettingsLanguageInteger : public DuiSettingsLanguageNode
{
public:
    struct MinMaxValue {
     ...
     */
    DuiSettingsLanguageInteger(const QString &key, const QString &title);

    /*!
     * Destructor
     */
    virtual ~DuiSettingsLanguageInteger();
