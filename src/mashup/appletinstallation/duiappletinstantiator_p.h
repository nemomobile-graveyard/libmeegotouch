...
#ifndef DUIAPPLETINSTANTIATOR_P_H_
#define DUIAPPLETINSTANTIATOR_P_H_
...
/*!
 * Private class for DuiAppletInstantiator.
 */
class DuiAppletInstantiatorPrivate : public QObject
{
    Q_OBJECT

public:
    /*!
     * Creates a new private class for DuiAppletInstantiator.
     */
    DuiAppletInstantiatorPrivate();

    /*!
     * Destroys the DuiAppletInstantiatorPrivate.
     */
    virtual ~DuiAppletInstantiatorPrivate();
    ...
    //! Name of the DuiAppletInstanceManager D-Bus Interface
...
#endif /* DUIAPPLETINSTANTIATOR_P_H_ */
