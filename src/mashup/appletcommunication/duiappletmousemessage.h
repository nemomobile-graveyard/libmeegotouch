...
#ifndef DUIAPPLETMOUSEMESSAGE_H
 ...
 */
class DUI_EXPORT DuiAppletMouseMessage : public DuiAppletMessage
{
private:
...
public:
     ...
     */
    DuiAppletMouseMessage(DuiAppletMessageType type, const QPointF &pos = QPointF(), Qt::MouseButton button = Qt::NoButton, Qt::MouseButtons buttons = Qt::NoButton);

    /*!
     * Destructor.
     */
    virtual ~DuiAppletMouseMessage();
