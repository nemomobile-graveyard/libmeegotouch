...
#ifndef DUIAPPLETCOMMUNICATOR_H_
#define DUIAPPLETCOMMUNICATOR_H_
...
/*!
 * The DuiAppletCommunicator is a base class for implementing interprocess
 * communication between two processes (a host application and an applet).
 */
class DUI_EXPORT DuiAppletCommunicator : public QObject
{
    Q_OBJECT

public:
    /*!
     * Constructs an DuiAppletCommunicator.
     */
    DuiAppletCommunicator();

    /*!
     * Destroys the DuiAppletCommunicator.
     */
    virtual ~DuiAppletCommunicator();
    ...
    /*!
     * Sends a DuiAppletMessage.
     *
     * \param message the DuiAppletMessage to send
     * \return the result of the operation: \c true if sending was successful and \c false otherwise.
     */
    bool sendMessage(const DuiAppletMessage &message);
...
private:
    ...
    DuiAppletMessage::DuiAppletMessageType receivedMessageType;
...
#endif /* DUIAPPLETCOMMUNICATOR_H_ */
