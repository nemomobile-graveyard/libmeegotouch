...
#ifndef DUIAPPLETPIXMAPMODIFIEDMESSAGE_H
#define DUIAPPLETPIXMAPMODIFIEDMESSAGE_H
 ...
 */
class DUI_EXPORT DuiAppletPixmapModifiedMessage : public DuiAppletMessage
{
private:
...
public:
    /*!
     * Constructs a DuiAppletPixmapModifiedMessage.
     *
     ...
     */
    explicit DuiAppletPixmapModifiedMessage(const QRectF &geometry = QRectF());

    /*!
     * Destroys the DuiAppletPixmapModifiedMessage.
     */
    virtual ~DuiAppletPixmapModifiedMessage();
...
#endif // DUIAPPLETPIXMAPMODIFIEDMESSAGE_H
