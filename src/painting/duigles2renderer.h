...
/*!
    \class DuiGLES2Renderer
    \brief A singleton class for rendering textured quads with custom shaders.

    DuiGLES2Renderer class implements and provides an easy interface for
    ...
    initialized by the DuiGLES2Renderer class automatically:
    ...
    \endcode
*/
class DUI_EXPORT DuiGLES2Renderer
{
public:
    ...
    /*!
        \brief Destructor.
     */
    virtual ~DuiGLES2Renderer();

    /*!
        \brief Returns instance of DuiGLES2Renderer object for the specified QGLWidget.

        If the renderer for the specified glWidget does not yet exist it
        will be  created and initialized.

        Renderer object is created automatically for each DuiWindow if SW
        rendering is enabled.

        \return DuiGLES2Renderer object
    */
    static DuiGLES2Renderer *instance(QGLWidget *glWidget);

    /*!
        \brief Returns instance of DuiGLES2Renderer which was previously set active.

        Returns NULL if no renderer has been set active.

        In normal cases widgets should call this method when they need instance
        of the renderer. DuiWindow is responsible for activating a renderer.
        ...
        \return Active DuiGLES2Renderer object
    */
    static DuiGLES2Renderer *instance();
    ...
    /*!
        ...
        DuiWindow is responsible for setting the active renderer automatically
    ...
    */
    ...
    /*!
        \brief Begin painting with DuiGLES2Renderer using default program.
    ...
    */
    ...
    /*!
        \brief Begin painting with DuiGLES2Renderer using the specified program.
...
private:
    ...
    */
    ...
    DuiGLES2RendererPrivate *const d_ptr;

    Q_DISABLE_COPY(DuiGLES2Renderer)
    Q_DECLARE_PRIVATE(DuiGLES2Renderer)
};
