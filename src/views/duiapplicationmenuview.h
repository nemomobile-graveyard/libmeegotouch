...
#ifndef DUIAPPLICATIONMENUVIEW_H
#define DUIAPPLICATIONMENUVIEW_H
...
class DuiApplicationMenuViewPrivate;

/*!
    \class DuiApplicationMenuView
    \brief View class for DuiApplicationMenu.

    \ingroup views

    \section DuiApplicationMenuViewOverview Overview
        DuiApplicationMenuView is used to visualize actions placed into the DuiApplicationMenu.
        DuiApplicationMenuView appears once the user clicks on the view menu title area. It is opened on
        ...
        DuiApplicationMenuStyle and DuiSceneWindowStyle.

        The following action widgets are supported for this particular view:
        - Button, Icon button variant
        - Combobox

        \subsection DuiApplicationMenuViewCommands Commands
    ...
    \section DuiApplicationMenuInteractions Interactions
    ...
    \sa DuiApplicationMenu DuiApplicationMenuModel DuiApplicationMenuStyle

*/

class DUI_EXPORT DuiApplicationMenuView : public DuiSceneWindowView
{
    Q_OBJECT
    DUI_VIEW(DuiApplicationMenuModel, DuiApplicationMenuStyle)

protected:
    DuiApplicationMenuViewPrivate *const d_ptr;

public:
    /*!
        \brief Constructs DuiApplicationMenuView with a pointer to the controller
     */
    DuiApplicationMenuView(DuiApplicationMenu *controller);

    /*!
     * \brief Destructs DuiApplicationMenuView
     */
    virtual ~DuiApplicationMenuView();
...
protected:
    ...
    //! \reimp_end
    DuiApplicationMenuView(DuiApplicationMenuViewPrivate &dd, DuiApplicationMenu *controller);

private:
    Q_DISABLE_COPY(DuiApplicationMenuView)
    Q_DECLARE_PRIVATE(DuiApplicationMenuView)

#ifdef UNIT_TEST
    friend class Pt_DuiApplicationMenu;
#endif
