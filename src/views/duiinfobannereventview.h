...
#ifndef DUIINFOBANNEREVENTVIEW_H
#define DUIINFOBANNEREVENTVIEW_H
...
class DuiInfoBanner;
class DuiInfoBannerEventViewPrivate;

/*!
    \class DuiInfoBannerEventView
    \brief A class that represents a modeless notification banner.

    \ingroup views

    \section DuiInfoBannerEventViewOverview Overview
    ...
    \section DuiInfoBannerEventViewInteractions Interactions
        <TABLE border="1">
...
class DUI_EXPORT DuiInfoBannerEventView : public DuiSceneWindowView
{
    Q_OBJECT
    DUI_VIEW(DuiInfoBannerModel, DuiInfoBannerStyle)

protected:
    DuiInfoBannerEventViewPrivate *const d_ptr;
...
public:
    ...
    */
    DuiInfoBannerEventView(DuiInfoBanner *controller);

    /*!
        \brief Destructor
    */
    virtual ~DuiInfoBannerEventView();
...
protected:
    ...
    /*!
        ...
        \param controller  Pointer to the banner's controller
    */
    DuiInfoBannerEventView(DuiInfoBannerEventViewPrivate &dd, DuiInfoBanner *controller);
...
private:
    Q_DECLARE_PRIVATE(DuiInfoBannerEventView)
};
