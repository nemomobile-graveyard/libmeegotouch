...
#ifndef DUIINFOBANNERINFORMATIONVIEW_H
#define DUIINFOBANNERINFORMATIONVIEW_H

#include "duiscenewindowview.h"
#include "duiinfobannermodel.h"
#include "duiinfobannerstyle.h"

class DuiInfoBanner;
class DuiInfoBannerInformationViewPrivate;

/*!
    \class DuiInfoBannerInformationView
    \brief A class that represents a modeless notification banner.

    \ingroup views

    \section DuiInfoBannerInformationViewOverview Overview
    ...
    \section DuiInfoBannerInformationViewInteractions Interactions
        <TABLE border="1">
    ...
    \section DuiInfoBannerInteractiveOverview Interactive information banner
        ...
        - An interactive information banner can have only one function associated to it. The button can be
          enabled using DuiInfoBanner::setButtonText method.
    ...
    \section DuiInfoBannerInteractiveInteractions Interactions
        <TABLE border="1">
        <TR><TH>Event</TH><TH>Action</TH><TH>Transition</TH><TH>Tactile feedback</TH><TH>Audio feedback</TH></TR>
        <TR><TD>-</TD>
    ...
    \sa DuiNotification
*/
class DUI_EXPORT DuiInfoBannerInformationView : public DuiSceneWindowView
{
    Q_OBJECT
    DUI_VIEW(DuiInfoBannerModel, DuiInfoBannerStyle)

protected:
    DuiInfoBannerInformationViewPrivate *const d_ptr;
...
public:
    ...
    */
    DuiInfoBannerInformationView(DuiInfoBanner *controller);

    /*!
        \brief Destructor
    */
    virtual ~DuiInfoBannerInformationView();
...
protected:
    ...
    /*!
        ...
        \param controller  Pointer to the banner's controller
    */
    DuiInfoBannerInformationView(DuiInfoBannerInformationViewPrivate &dd, DuiInfoBanner *controller);
...
protected Q_SLOTS:
    ...
    //! \reimp_end
private:
    Q_DISABLE_COPY(DuiInfoBannerInformationView)
    Q_DECLARE_PRIVATE(DuiInfoBannerInformationView)
};
