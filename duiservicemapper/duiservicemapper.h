...
class DuiServiceMapperPrivate;

class DuiServiceMapper : public QObject
{
    Q_OBJECT
public:
    /*
     ...
     */
    DuiServiceMapper(const QString &serviceFileDir);

    /*
     * \brief Destructor
     */
    virtual ~DuiServiceMapper();
...
private:
    ...
    DuiServiceMapperPrivate *d_ptr;

#ifdef UNIT_TEST
    friend class Ut_DuiServiceMapper;
#endif // UNIT_TEST
};
#endif
//! \endcond
