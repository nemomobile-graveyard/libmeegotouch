...
#include "ut_duipannablewidget.h"
...
static Ut_DuiPannableWidget *gTester = 0;
...
void Ut_DuiPannableWidget::initTestCase()
{
    static int argc = 1;
...
void Ut_DuiPannableWidget::cleanupTestCase()
{
    gTester = 0;
    delete app;
}
...
void Ut_DuiPannableWidget::init()
{
    _widget = new DuiPannableWidget();
    _currentResult = new StateTransitionResult();
}

void Ut_DuiPannableWidget::cleanup()
{
...
void Ut_DuiPannableWidget::testWaitState_data()
{
    ...
    results.push_back(StateTransitionResult(int(DuiPannableWidgetPrivate::Wait)));

    // Result after mouse press event
    expectedEvents.push_back(UNGRAB_MOUSE);
    expectedEvents.push_back(PHYS_MOUSE_PRESS);
    results.push_back(StateTransitionResult(int(DuiPannableWidgetPrivate::Evaluate), expectedEvents));
    expectedEvents.clear();

    // Result after mouse release event
    results.push_back(StateTransitionResult(int(DuiPannableWidgetPrivate::Wait), expectedEvents));
...
void Ut_DuiPannableWidget::testWaitState()
{
    // Set the pannable widget into wait state
    static_cast<DuiPannableWidgetPrivate *>(_widget->d_ptr)->state = DuiPannableWidgetPrivate::Wait;

    testStateTransitions();
}

void Ut_DuiPannableWidget::testEvaluateState_data()
{
    QList<StateTransitionEvent> expectedEvents;
    ...
    // Result after no events
    results.push_back(StateTransitionResult(int(DuiPannableWidgetPrivate::Evaluate)));
    ...
    results.push_back(StateTransitionResult(int(DuiPannableWidgetPrivate::Pan), expectedEvents));
    expectedEvents.clear();

    createTestData(results);
}

void Ut_DuiPannableWidget::testEvaluateState()
{
    // Set the pannable widget into evaluate state
    static_cast<DuiPannableWidgetPrivate *>(_widget->d_ptr)->state = DuiPannableWidgetPrivate::Evaluate;

    testStateTransitions();
}

void Ut_DuiPannableWidget::testPanState_data()
{
    QList<StateTransitionEvent> expectedEvents;
    ...
    // Result after no events
    results.push_back(StateTransitionResult(int(DuiPannableWidgetPrivate::Pan)));
...
void Ut_DuiPannableWidget::testPanState()
{
    // Set the pannable widget into pan state
    static_cast<DuiPannableWidgetPrivate *>(_widget->d_ptr)->state = DuiPannableWidgetPrivate::Pan;

    testStateTransitions();
}

void Ut_DuiPannableWidget::createTestData(QList<StateTransitionResult> results)
{
...
void Ut_DuiPannableWidget::testStateTransitions()
{
    ...
    QCOMPARE(static_cast<DuiPannableWidgetPrivate *>(_widget->d_ptr)->state, result._targetState);

    _currentResult->compare(result);
}

void Ut_DuiPannableWidget::testRightMouseButton()
{
    QGraphicsSceneMouseEvent *mouseEvent;
    mouseEvent = new QGraphicsSceneMouseEvent(QEvent::GraphicsSceneMousePress);
