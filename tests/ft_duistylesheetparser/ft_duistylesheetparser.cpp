...
void Ft_DuiStyleSheetParser::test_load()
{
    ...
    attributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-integer"), "10");
    attributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-real"), "10.0");
    attributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-string"), "\"string;\"");
    attributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-bool"), "true");
    attributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-point"), "10px 10px");
    attributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-font"), "sans 10px");
    attributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-color"), "#ffffff");

    QMap<QString, QString> parentAttributes;
    parentAttributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-integer"), "10");
    parentAttributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-real"), "10.0");
    parentAttributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-string"), "\"string\"");
    parentAttributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-bool"), "true");
    parentAttributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-point"), "10px 10px");
    parentAttributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-font"), "sans 10px");
    parentAttributes.insert(DuiStyleSheetAttribute::attributeNameToPropertyName("attribute-color"), "#ffffff");
...
void Ft_DuiStyleSheetParser::test_constants()
{
    ...
    info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-width"), NULL);
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-width"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-width"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-width")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-width"))->value, QString("10px"));
    info = m_subject->fileInfoList()[2];
    QCOMPARE(info->selectors.count(), 1);
    QCOMPARE(info->selectors[0]->attributes()->count(), 13);
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-int"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-int"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-int")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-int"))->value, QString("10"));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-string1"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-string1"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-string1")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-string1"))->value, QString("\"name\""));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-string2"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-string2"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-string2")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-string2"))->value, QString("\"this is a string with constant $cName\""));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-bool"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-bool"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-bool")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-bool"))->value, QString("true"));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-pos1"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-pos1"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-pos1")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-pos1"))->value, QString("10px 15px"));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-pos2"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-pos2"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-pos2")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-pos2"))->value, QString("17px 11px"));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-font1"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-font1"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-font1")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-font1"))->value, QString("sans 12px"));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-font2"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-font2"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-font2")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-font2"))->value, QString("arial 10px"));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-color"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-color"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-color")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-color"))->value, QString("#0abba0"));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-invalid"), NULL));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-invalid"))->name, QString(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-invalid")));
    QCOMPARE(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-invalid"))->value, QString(""));
    QVERIFY(info->selectors[0]->attributes()->value(DuiStyleSheetAttribute::attributeNameToPropertyName("attr-void"), NULL));
