...
#include "ft_duiprogressindicator.h"
#include <QtTest>
#include <QImage>
...
void Ft_DuiProgressIndicator::initTestCase()
{
    static int argc = 1;
...
void Ft_DuiProgressIndicator::cleanupTestCase()
{
    delete app;
}

void Ft_DuiProgressIndicator::init()
{
    m_subject = new DuiProgressIndicator();
}

void Ft_DuiProgressIndicator::cleanup()
{
    delete m_subject;
}

void Ft_DuiProgressIndicator::setValue()
{
    // init
...
void Ft_DuiProgressIndicator::setMinimum()
{
    // init
    m_subject->setMinimum(2);
    m_subject->setMaximum(7);
...
void Ft_DuiProgressIndicator::setMaximum()
{
    // init
    m_subject->setMinimum(2);
    m_subject->setMaximum(7);
...
void Ft_DuiProgressIndicator::unknown()
{
...
void Ft_DuiProgressIndicator::reset()
{
...
QTEST_APPLESS_MAIN(Ft_DuiProgressIndicator)
