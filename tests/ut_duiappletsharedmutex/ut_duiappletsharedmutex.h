...
#ifndef UT_DUIAPPLETSHAREDMUTEX_H
#define UT_DUIAPPLETSHAREDMUTEX_H

#include <QObject>

class DuiAppletSharedMutex;

class Ut_DuiAppletSharedMutex : public QObject
{
    Q_OBJECT
...
private:
    DuiAppletSharedMutex *mutex1;
    DuiAppletSharedMutex *mutex2;
    DuiAppletSharedMutex *mutex3;
};
