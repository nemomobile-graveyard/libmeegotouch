...
#ifndef UT_DUIAPPLETGCONFDATASTORE_H
#define UT_DUIAPPLETGCONFDATASTORE_H
...
class Ut_DuiGConfDataStore : public QObject
{
    Q_OBJECT
...
private:
    DuiGConfDataStore *m_subject;

    QList<QPair<QString, QVariant> > stringVariantSlotArguments;
};

#endif  // UT_DUIAPPLETGCONFDATASTORE_H
