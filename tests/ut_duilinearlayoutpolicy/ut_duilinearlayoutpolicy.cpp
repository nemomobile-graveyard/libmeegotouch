...
#include "ut_duilinearlayoutpolicy.h"
...
Ut_DuiLinearLayoutPolicy::Ut_DuiLinearLayoutPolicy()
    : m_mockLayout(0)
    , m_policy(0)
    , m_mockItem100(0)
    , m_mockItem200(0)
...
DuiApplication *app;
void Ut_DuiLinearLayoutPolicy::initTestCase()
{
    static int argc = 1;
    static char *argv[1] = { (char *) "./ut_duilinearlayoutpolicy" };
    app = new DuiApplication(argc, argv);
    app->setLayoutDirection(Qt::LeftToRight);
}

void Ut_DuiLinearLayoutPolicy::cleanupTestCase()
{
    delete app;
}

void Ut_DuiLinearLayoutPolicy::init()
{
    ...
    m_policy = new DuiLinearLayoutPolicy(m_mockLayout, Qt::Horizontal);
...
void Ut_DuiLinearLayoutPolicy::cleanup()
{
    Q_ASSERT(0 != m_mockItem100);
...
void Ut_DuiLinearLayoutPolicy::testSpacing()
{
    // general spacing
...
void Ut_DuiLinearLayoutPolicy::testStretch_data()
{
    //Run the test one with QGraphicsLinearLayout to check that the test itself is
    //correct, then again with libdui to check DuiLinearLayoutPolicy is correct
    QTest::addColumn<bool>("useQt");
    QTest::newRow("QGraphicsLinearLayout") << true;
    QTest::newRow("DuiLinearLayoutPolicy") << false;
}
void Ut_DuiLinearLayoutPolicy::testStretch()
{
    QFETCH(bool, useQt);
...
void Ut_DuiLinearLayoutPolicy::testInsertingItems()
{
...
QTEST_APPLESS_MAIN(Ut_DuiLinearLayoutPolicy)
