...
#ifndef UT_MPROGRESSINDICATORSPINNERVIEW_H
#define UT_MPROGRESSINDICATORSPINNERVIEW_H
...
class Ut_MProgressIndicatorSpinnerView : public QObject
{
    Q_OBJECT
public:
