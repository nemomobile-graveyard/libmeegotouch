...
#include "ut_duiseekbar.h"

#include <QDebug>

void Ut_DuiSeekBar::seekbarSetLoadedContentMinimum()
{
    DuiSeekBar *s = new DuiSeekBar();
...
void Ut_DuiSeekBar::seekbarSetLoadedContentMaximum()
{
    DuiSeekBar *s = new DuiSeekBar();
...
void Ut_DuiSeekBar::seekbarSetLoadedContentRange()
{
    DuiSeekBar *s = new DuiSeekBar();
...
void Ut_DuiSeekBar::seekbarTestOutOfLoadedContentRange()
{
    DuiSeekBar *s = new DuiSeekBar();
...
QTEST_APPLESS_MAIN(Ut_DuiSeekBar)
