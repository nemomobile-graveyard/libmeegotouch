...
#include "ut_duiphysics2dpanning.h"

#define QFLOATCOMPARE(x,y)  QCOMPARE(x+1.0,y+1.0)

QList<QString> Ut_DuiPhysics2DPanning::timeLineActions;
QTimeLine::State Ut_DuiPhysics2DPanning::timeLineState;
...
void QTimeLine::setDuration(int duration)
{
    ...
    Ut_DuiPhysics2DPanning::timeLineActions.push_back(str);
}
...
{
    return Ut_DuiPhysics2DPanning::timeLineState;
}

void Ut_DuiPhysics2DPanning::initTestCase()
{
    static int argc = 1;
...
void Ut_DuiPhysics2DPanning::cleanupTestCase()
{
    delete app;
}


void Ut_DuiPhysics2DPanning::init()
{
    DuiPannableWidget *pannable = new DuiPannableWidget();
...
void Ut_DuiPhysics2DPanning::cleanup()
{
    delete physics;
}


void Ut_DuiPhysics2DPanning::initValues()
{
...
void Ut_DuiPhysics2DPanning::timeLineInStart1()
{
...
void Ut_DuiPhysics2DPanning::timeLineInStart2()
{
    // Checks that timeline is not initialized in case it was already running

    Ut_DuiPhysics2DPanning::timeLineState = QTimeLine::Running;
...
void Ut_DuiPhysics2DPanning::timeLineInStop()
{
    physics->stop();
...
void Ut_DuiPhysics2DPanning::setAndGetQSizeF_data()
{
...
void Ut_DuiPhysics2DPanning::setAndGetQSizeF()
{
    QSizeF readvalue;
...
void Ut_DuiPhysics2DPanning::setAndGetQPointF_data()
{
...
void Ut_DuiPhysics2DPanning::setAndGetQPointF()
{
    QPointF readvalue;
...
void Ut_DuiPhysics2DPanning::timeLineStateQuery()
{
    Ut_DuiPhysics2DPanning::timeLineState = QTimeLine::NotRunning;
    QCOMPARE(physics->inMotion(), false);

    Ut_DuiPhysics2DPanning::timeLineState = QTimeLine::Paused;
    QCOMPARE(physics->inMotion(), false);
...
void Ut_DuiPhysics2DPanning::pointerPress()
{
...
void Ut_DuiPhysics2DPanning::pointerMove()
{
...
void Ut_DuiPhysics2DPanning::integrating_data()
{
...
void Ut_DuiPhysics2DPanning::integrating()
{
    int i, j;
    qreal x, y;
    int frame = 0;
...
void Ut_DuiPhysics2DPanning::positionShouldReturnToEndRangeAfterMovingViewportBeyondEndRange()
{
    physics->setRange(QRectF(10, 10, 100, 100));
...
void Ut_DuiPhysics2DPanning::integrationShouldStopAfterReachingPositionInsideRange()
{
    physics->setRange(QRectF(10, 10, 100, 100));
    physics->setPosition(QPointF(10, -30));
...
QTEST_APPLESS_MAIN(Ut_DuiPhysics2DPanning);
