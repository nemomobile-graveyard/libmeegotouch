...
#include "ut_duigridlayoutpolicy.h"
...
Ut_DuiGridLayoutPolicy::Ut_DuiGridLayoutPolicy()
    : m_mockLayout(0)
    , m_policy(0)
    , m_mockItem100(0)
    , m_mockItem200(0)
...
DuiApplication *app;
void Ut_DuiGridLayoutPolicy::initTestCase()
{
    static int argc = 1;
    static char *argv[1] = { (char *) "./ut_duigridlayoutpolicy" };
    app = new DuiApplication(argc, argv);
    app->setLayoutDirection(Qt::LeftToRight);
}

void Ut_DuiGridLayoutPolicy::cleanupTestCase()
{
    delete app;
}

void Ut_DuiGridLayoutPolicy::init()
{
    ...
    Q_ASSERT(0 == m_policy);
    m_policy = new DuiGridLayoutPolicy(m_mockLayout);
...
void Ut_DuiGridLayoutPolicy::cleanup()
{
    Q_ASSERT(0 != m_mockItem100);
...
void Ut_DuiGridLayoutPolicy::testDeletingLayout()
{
...
/** Simplest test with one item, all the layout's sizes are determined by the
    sizes of the item. */
void Ut_DuiGridLayoutPolicy::testOneItemLayout()
{
...
void Ut_DuiGridLayoutPolicy::testHorizontally()
{
...
void Ut_DuiGridLayoutPolicy::testVertically()
{
    m_policy->setSpacing(0.0);
    m_policy->addItem(m_mockItem100, 0, 0);
...
void Ut_DuiGridLayoutPolicy::testHorizontallyAndVertically()
{
    m_policy->setSpacing(0.0);
    m_policy->addItem(m_mockItem100, 0, 0);
    m_policy->addItem(m_mockItem200, 0, 1);
...
void Ut_DuiGridLayoutPolicy::testSpacing()
{
    // general spacing
...
void Ut_DuiGridLayoutPolicy::testAlignment()
{
    // general spacing
    m_policy->setSpacing(0.0);
    m_policy->addItem(m_mockItem100, 0, 0);
...
void Ut_DuiGridLayoutPolicy::testAlignmentSubLayouts()
{
    // general spacing
    m_policy->setSpacing(0.0);

    // create two sublayouts
    DuiLayout *subLayout100 = new DuiLayout;
    subLayout100->setAnimation(0);
    DuiGridLayoutPolicy *subPolicy100 = new DuiGridLayoutPolicy(subLayout100);
    m_policy->addItem(subLayout100, 0, 0);
    subPolicy100->setSpacing(0.0);
    subPolicy100->addItem(m_mockItem100, 0, 0);

    DuiLayout *subLayout200 = new DuiLayout;
    subLayout200->setAnimation(0);
    DuiGridLayoutPolicy *subPolicy200 = new DuiGridLayoutPolicy(subLayout200);
...
void Ut_DuiGridLayoutPolicy::testRowCount()
{
...
QTEST_APPLESS_MAIN(Ut_DuiGridLayoutPolicy)
