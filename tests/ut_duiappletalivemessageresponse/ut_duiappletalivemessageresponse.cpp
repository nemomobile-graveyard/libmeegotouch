...
#include "ut_duiappletalivemessageresponse.h"

#include <QtTest/QtTest>
#include "duiappletalivemessageresponse.h"

void Ut_DuiAppletAliveMessageResponse::init()
{
    message = new DuiAppletAliveMessageResponse();
}

void Ut_DuiAppletAliveMessageResponse::cleanup()
{
    delete message;
}
