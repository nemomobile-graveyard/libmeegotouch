...
#include "ut_duiappletobjectmenumessage.h"

#include <QtTest/QtTest>
#include <QAction>
#include "duiappletobjectmenumessage.h"

void Ut_DuiAppletObjectMenuMessage::init()
{
    ...
    message = new DuiAppletObjectMenuMessage(actions);
}

void Ut_DuiAppletObjectMenuMessage::cleanup()
{
    delete message;
    delete stream;
    delete buffer;
...
void Ut_DuiAppletObjectMenuMessage::testType()
{
    QCOMPARE(message->type(), DuiAppletMessage::OBJECT_MENU_MESSAGE);
}

void Ut_DuiAppletObjectMenuMessage::testSerialization()
{
...
void Ut_DuiAppletObjectMenuMessage::testUnserialization()
{
    QList<QString> actionNames;
...
void Ut_DuiAppletObjectMenuMessage::testActionList()
{
    QCOMPARE(message->actionList().at(0), QString("action1"));
}

QTEST_APPLESS_MAIN(Ut_DuiAppletObjectMenuMessage)
