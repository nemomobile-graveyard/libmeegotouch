...
#ifndef UT_DUIAPPLETCOMMUNICATOR_H
#define UT_DUIAPPLETCOMMUNICATOR_H

#include <duiappletcommunicator.h>

class TestAppletCommunicator : public DuiAppletCommunicator
{
    Q_OBJECT
...
class Ut_DuiAppletCommunicator : public QObject
{
    Q_OBJECT
