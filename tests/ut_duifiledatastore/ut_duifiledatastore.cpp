...
void Ut_DuiFileDataStore::init()
{
    ...
    m_subject = new DuiFileDataStore(QString("/tmp/store.data"));
}

void Ut_DuiFileDataStore::cleanup()
{
    delete m_subject;
    m_subject = NULL;
...
void Ut_DuiFileDataStore::testFileOpening()
{
...
void Ut_DuiFileDataStore::testValueSetting()
{
...
void Ut_DuiFileDataStore::testDataRemoval()
{
    m_subject->createValue(QString("key"), QVariant(QString("value")));
...
void Ut_DuiFileDataStore::testClear()
{
    m_subject->createValue(QString("key"), QVariant(QString("value")));
...
void Ut_DuiFileDataStore::testFileNotReadable()
{
...
void Ut_DuiFileDataStore::testFileNotWritable()
{
    m_subject->createValue("foo", "bar");
...
void Ut_DuiFileDataStore::testFileContentsInvalid()
{
...
void Ut_DuiFileDataStore::testSettingsFileModifiedExternally()
{
    ...
    // because DuiFileDataStore's file change notification merely compares
...
void Ut_DuiFileDataStore::testSyncFailure()
{
    m_subject->createValue("foo", "bar");
...
QTEST_APPLESS_MAIN(Ut_DuiFileDataStore)
