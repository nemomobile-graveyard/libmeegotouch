 ...
 */
void Ut_DuiCompleter::initTestCase()
{
    int dummyArgc = 1;
    char *dummyArgv = (char *) "./ut_duicompleter";
    ...
    m_editWidget = new DuiTextEdit(DuiTextEditModel::MultiLine, "");
    m_subject = new DuiCompleter();
 ...
 */
void Ut_DuiCompleter::cleanupTestCase()
{
    delete m_editWidget;
    m_editWidget = 0;
    delete m_subject;
...
void Ut_DuiCompleter::init()
{
    ...
    (static_cast<DuiCompleterPrivate *>(m_subject->d_ptr))->completerTimer->setInterval(0);
 ...
 */
void Ut_DuiCompleter::cleanup()
{
}

void Ut_DuiCompleter::checkConstruct()
{
    QStringList testlist;
    testlist << "apple" << "appreciate" << "orange" << "offset";
    DuiCompleter *completer1 = new DuiCompleter(testlist);
    ...
    DuiCompleter *completer2 = new DuiCompleter(testModel2);
    ...
    DuiCompleter *completer3 = new DuiCompleter();
...
void Ut_DuiCompleter::checkWidget()
{
    //test the widget
...
void Ut_DuiCompleter::checkPrefix()
{
    QString prefix2 = "ap";
...
void Ut_DuiCompleter::checkCandidates()
{
    QStringList testlist;
    testlist << "apple" << "appreciate" << "orange" << "offset"
...
void Ut_DuiCompleter::checkMultipleEntries()
{
    m_subject->setAcceptMultipleEntries(true);
...
void Ut_DuiCompleter::checkComplete()
{
    //using model, and give left and right delimiters
    DuiCompleter *completer1 = new DuiCompleter(testModel);
    completer1->setCharactersToTrim(QString("<>"));
    DuiTextEdit *editWidget1 = new DuiTextEdit(DuiTextEditModel::MultiLine, "", 0);
    ...
    //set the completing time interval to 0, avoid wait
    (static_cast<DuiCompleterPrivate *>(completer1->d_ptr))->completerTimer->setInterval(0);
...
void Ut_DuiCompleter::checkTrim()
{
    //if don't trim
...
QTEST_APPLESS_MAIN(Ut_DuiCompleter);
