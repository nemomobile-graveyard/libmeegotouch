...
#ifndef UT_DUISERVICEFWBASEIF_H
#define UT_DUISERVICEFWBASEIF_H
...
Q_DECLARE_METATYPE(DuiServiceFwBaseIf *);

class Ut_DuiServiceFwBaseIf : public QObject
{
    Q_OBJECT
