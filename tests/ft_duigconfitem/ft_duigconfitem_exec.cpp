...
#include "ft_duigconfitem_exec.h"
...
void DuiGConfItemTests::timeout()
{
    timed_out = true;
    timer.stop();
}
...
// Before all tests
void DuiGConfItemTests::initTestCase()
{
...
// After all tests
void DuiGConfItemTests::cleanupTestCase()
{
}

// Before each test
void DuiGConfItemTests::init()
{
    boolItem = new DuiGConfItem("/Test/Bool");
    intItem = new DuiGConfItem("/Test/Int");
    stringItem = new DuiGConfItem("/Test/String");
    doubleItem = new DuiGConfItem("/Test/Double");
    stringListItem = new DuiGConfItem("/Test/StringList");
    intListItem = new DuiGConfItem("/Test/IntList");
    doubleListItem = new DuiGConfItem("/Test/DoubleList");
    boolListItem = new DuiGConfItem("/Test/BoolList");
    unsetBeforeItem = new DuiGConfItem("/Test/UnsetBefore");
    unsetAfterItem = new DuiGConfItem("/Test/UnsetAfter");
...
// After each test
void DuiGConfItemTests::cleanup()
{
...
void DuiGConfItemTests::external_values()
{
...
void DuiGConfItemTests::set_bool()
{
...
void DuiGConfItemTests::set_int()
{
    signalSpy->numberOfCalls = 0;
...
void DuiGConfItemTests::set_string()
{
    signalSpy->numberOfCalls = 0;
...
void DuiGConfItemTests::set_unicode_string()
{
    signalSpy->numberOfCalls = 0;
...
void DuiGConfItemTests::set_double()
{
    signalSpy->numberOfCalls = 0;
...
void DuiGConfItemTests::set_string_list()
{
    signalSpy->numberOfCalls = 0;
...
void DuiGConfItemTests::set_int_list()
{
    signalSpy->numberOfCalls = 0;
...
void DuiGConfItemTests::set_double_list()
{
    signalSpy->numberOfCalls = 0;
...
void DuiGConfItemTests::set_bool_list()
{
    signalSpy->numberOfCalls = 0;
...
void DuiGConfItemTests::list_dirs()
{
    DuiGConfItem test("/Test");
...
void DuiGConfItemTests::list_entries()
{
    DuiGConfItem test("/Test");
...
void DuiGConfItemTests::get_default()
{
    intItem->unset();
...
void DuiGConfItemTests::propagate()
{
    DuiGConfItem secondIntItem("/Test/Int");
    secondIntItem.set(3000);
    QVERIFY_TIMEOUT(2000, intItem->value() == secondIntItem.value());
    QCOMPARE(signalSpy->numberOfCalls, 1);
}

void DuiGConfItemTests::set_external()
{
