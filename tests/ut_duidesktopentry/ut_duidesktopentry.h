...
#ifndef UT_DUIDESKTOPENTRY_H
#define UT_DUIDESKTOPENTRY_H

#include <QtTest/QtTest>
#include <QObject>

// the real unit/duidesktopentry class declaration
#include <duidesktopentry.h>

class Ut_DuiDesktopEntry : public QObject
{
    Q_OBJECT

private:
    DuiDesktopEntry *m_subject;
